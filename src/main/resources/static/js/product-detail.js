...
//  * FIX: Chuyển vị trí thông báo xuống góc dưới bên phải để tránh che Header
//  */
...
// // ===== HELPER: THÔNG BÁO AN TOÀN (VỊ TRÍ MỚI) =====
// const notify = {
//     toast: (msg, icon = 'success') => {
//         if (typeof Swal === 'undefined') {
//             console.warn("SweetAlert2 chưa tải. Dùng alert thay thế.");
//             alert(msg);
//             return;
//         }
//         const Toast = Swal.mixin({
//             toast: true,
//             position: 'bottom-end', // FIX: Đã đổi từ top-end sang bottom-end
...
/**
 * EAZY VIBES - PRODUCT DETAIL ENGINE (FIXED SYNC)
 */
